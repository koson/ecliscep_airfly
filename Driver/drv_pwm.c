...
{
	if(value>PwmMaxValue)	value = PwmMaxValue;
	if(value<PwmMimValue)	value = PwmMimValue;
	TIM1->CCR1 = value;
}
...
void Pwm_Cap_Init(u16 arr, u16 psc)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_2| GPIO_Pin_3 | GPIO_Pin_6 | GPIO_Pin_7;  //PA0,1,2,3,6,7 清除之前设置  
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD; //PA0,1,2,3 输入 
	GPIO_Init(GPIOA, &GPIO_InitStructure);
	GPIO_ResetBits(GPIOA, GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_2| GPIO_Pin_3 | GPIO_Pin_6 | GPIO_Pin_7);//PA0,1,2,3,6,7 下拉
